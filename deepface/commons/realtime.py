...
def analysis(db_path, model_name='VGG-Face', detector_backend='opencv', distance_metric='cosine',
             enable_face_analysis=True, source=0, time_threshold=5, frame_threshold=5, capType='webcam',
             filePath=""):
    # ------------------------
    ...
    freezed_frame = 0
    tic = time.time()
    filePath = r"C:\Users\Zach Frank\PycharmProjects\DeepFace\Targets\Zach2.mp4"
    if capType == "video":
                ...
                if freezed_frame == 0:
                    ...
                    for detected_face in detected_faces_final:
                        ...
                        if enable_face_analysis == True:
                            ...
                            print(str(int(apparent_age)), " years old", "emotion: " + emotion_df.iloc[0, 0], " ",
